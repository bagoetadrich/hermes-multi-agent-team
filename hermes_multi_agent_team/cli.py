...
@click.option("--roles", default="pm,fe,be,qa,ui", help="Comma-separated role keys (pm,fe,be,qa,ui).")
...
def init(team_name: str, roles: str, prefix: str | None, clone_from: str | None, dry_run: bool) -> None:
    ...
    init_team(team_name=team_name, roles=roles, prefix=prefix, clone_from=clone_from, dry_run=dry_run)
